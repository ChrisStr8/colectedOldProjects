...
public class SlideshowCreator 
{
     ...
     */
    public SlideshowCreator(ImagesDouble images) {
        this.images = images;
    }
    ...
    public void redraw() { 
        ...
        // use standard cursor movement to iterate through images
        {
            ...
            ImageNodeDouble selectedImageNodeDouble = images.getCursor();
            ...
            for (int i=0; i<size; i++) {       
                ...
                if (images.getCursor() == selectedImageNodeDouble) {
            ...
            images.setCursor(selectedImageNodeDouble);
        }
        else
        // use Images iterator
        {

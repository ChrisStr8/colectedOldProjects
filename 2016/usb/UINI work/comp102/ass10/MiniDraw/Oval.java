...
public class Oval implements Shape {
    ...
    public void redraw(){
        ...
        UI.fillOval(x1, y1, width, height);
        UI.setColor(col);
        UI.fillOval(x1+1, y1+1, width-2, height-2);
    }
    ...
    public String toString(){
        /*# YOUR CODE HERE */
        return ("Oval "+col.getRed()+" "+col.getGreen()+" "+col.getBlue()+" "+this.x1+" "+this.y1+" "+this.width+" "+this.height);
    }

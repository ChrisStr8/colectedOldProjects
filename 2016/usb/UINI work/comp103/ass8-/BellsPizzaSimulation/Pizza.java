...
public class Pizza implements Comparable<Pizza> {
     ...
     * @param isUrgent - is true when the pizza has been ordered as being "urgent"
     */
     ...
     * Pizza price.
     * 
     * @return the price of the pizza, depending on whether it is an urgent delivery or not.
     */
    public double price() {
     ...
     * 
     * @return the prize of the pizza, multiplied by the 'late delivery' penalty factor.
     */
    ...
    public String toString () {
        return "Pizza received:" + orderedTime + " to "+destination +" by "+this.deadline()+(isUrgent?"(urgent) ":" ")+ deliveryTime+ "min";
    }
}

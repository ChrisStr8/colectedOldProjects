...
public abstract class GUI {
	...
	protected abstract void onSwitchFocus();

	protected abstract void onDriving();

	protected abstract void onWalking();

	protected abstract void onBiking();

	protected abstract void onPlotRoute();

	protected abstract void onArticulation();
	...
	private void initialise() {
		...
		JButton focusSwitch = new JButton("Switch");
		focusSwitch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				onSwitchFocus();
			}
		});

		JButton plotRoute = new JButton("Plot");
		plotRoute.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				onPlotRoute();
			}
		});

		JButton driving = new JButton("Driving");
		...
		JButton walking = new JButton("Walking");
		...
		JButton biking = new JButton("Biking");
		...
		JButton articulation = new JButton("Points");
		...
		loadquit.add(load);
		loadquit.add(quit);
		loadquit.add(focusSwitch);
		loadquit.add(plotRoute);
		loadquit.add(driving);
		loadquit.add(walking);
		loadquit.add(biking);

...
import SSGame.resources.FileResources;
 ...
 */
public class SSGame extends Observable{
    ...
    private final HashMap<String, GPiece> yellowPieces = new HashMap<>();
    private final HashMap<String, GPiece> greenPieces = new HashMap<>();
    private final List<String> changed = new ArrayList<>();
    private final Stack<String> actions = new Stack<>();
    private final Stack<GPiece[][]> oldBoards = new Stack<>();
    ...
    private void setupPieces(){
        File pieces = FileResources.PIECES.file;
        try {
    ...
    public boolean rotate(String letter, int rotation) {
        ...
        GPiece piece = findPiece(letter);
        return piece != null && rotate(piece, rotation);
    ...
    /**
     * list all the green Pieces in the cemetery
     * @return list of GPieces
     */
    public Queue<GPiece> gCemetery(){
        Queue<GPiece> pieces = new ArrayDeque<>();
        Set<String> greenLetters = greenPieces.keySet();
        for(String s : greenLetters) {
            GPiece piece = greenPieces.get(s);
    ...
    /**
     * list all the yellow Pieces in the cemetery
     * @return list of GPieces
     */
    public Queue<GPiece> yCemetery(){
        Queue<GPiece> pieces = new ArrayDeque<>();
        Set<String> yellowLetters = yellowPieces.keySet();
        for(String s : yellowLetters) {
            GPiece piece = yellowPieces.get(s);
    ...
    public boolean changed(GPiece piece){
        return changed.contains(piece.getName());
    }

    private void updateChanged(){
        Set<String> yellow = yellowPieces.keySet();
        Set<String> green = greenPieces.keySet();
        for (String s : yellow) {
            findPiece(s).changed=false;
        }
        for (String s : green) {
            findPiece(s).changed=false;
        }
        for (String s : changed) {
            findPiece(s).changed=true;
        }
    }

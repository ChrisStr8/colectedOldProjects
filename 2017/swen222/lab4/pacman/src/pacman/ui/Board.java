...
public class Board {
	...
	private Image[] RandomImages = new Image[]{loadImage("rghostright.png"),
		loadImage("rghostup.png"),
		loadImage("rghostdown.png"),
		loadImage("rghostleft.png")};

	private Image[] HomerImages = new Image[]{loadImage("hghostright.png"),
	...
	public synchronized void registerGhost(boolean homer) {
		...
		Character r;
		if(homer) {
			r = new StrategyGhost(portal[0]*30,portal[1]*30, MovingCharacter.STOPPED,
					HomerImages, new HomerStrategy());
		} else {
			r = new StrategyGhost(portal[0]*30,portal[1]*30, MovingCharacter.STOPPED,
					RandomImages, new RandomStrategy());
		}
		characters.add(r);
	}
